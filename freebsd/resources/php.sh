...
if [ ."$php_version" = ."7.4" ]; then
	...
	pkg install --yes php74-pcntl php74-zlib php74-filter php74-pdo_pgsql php74-pgsql php74-curl php74-mbstring
...
if [ ."$php_version" = ."8.1" ]; then
	...
	pkg install --yes php81-pcntl php81-zlib php81-filter php81-curl php81-mbstring
...
if [ ."$php_version" = ."8.2" ]; then
	...
	pkg install --yes php82-pcntl php82-zlib php82-filter php82-curl php82-mbstring
...
if [ ."$php_version" = ."8.3" ]; then
	...
	pkg install --yes php83-pcntl php83-zlib php83-filter php83-curl php83-mbstring
...
if [ ."$php_version" = ."8.4" ]; then
	...
	pkg install --yes php84-pcntl php84-zlib php84-filter php84-curl php84-mbstring
...
if [ ."$php_version" = ."8.5" ]; then
	...
	pkg install --yes php85-pcntl php85-zlib php85-filter php85-curl php85-mbstring
